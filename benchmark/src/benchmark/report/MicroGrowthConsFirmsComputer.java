 ...
 */
public class MicroGrowthConsFirmsComputer extends AbstractMicroComputer implements
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			...
			if (!firm.isDead()){
			double desiredGrowth = firm.getDesiredCapacityGrowth();
			result.put(firm.getAgentId(), desiredGrowth);
			}
			else{
