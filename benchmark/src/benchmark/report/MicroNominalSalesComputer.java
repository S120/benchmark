 ...
 *
 */
public class MicroNominalSalesComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent a:pop.getAgents()){
			...
			double nominalSales=firm.getPassedValue(StaticValues.LAG_NOMINALSALES, 0);
			result.put(firm.getAgentId(), nominalSales);
		}
		return result;
	}
