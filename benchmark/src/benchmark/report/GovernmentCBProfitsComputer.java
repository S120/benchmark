 ...
 *
 */
public class GovernmentCBProfitsComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			...
			result.put(gov.getAgentId(), gov.getProfitsFromCB());
		}
		return result;
	}
